...
public class AlunoModalidadeJTable1 extends JDialog {
    ...
    // private AlunoModalidadeTableModel1 tableModel;
    private AlunoModalidadeTableModel1 tableModel;

private DAODisciplinasHasModalidades daoDisciplinasHasModalidades = new DAODisciplinasHasModalidades();
    public AlunoModalidadeJTable1(String pegarCpf) {
...
//        List< AlunoHasDisciplinas> lista = new ArrayList<>();
//        tableModel = new AlunoModalidadeTableModel1(lista);
...
//                    AlunoHasDisciplinas eee = daoAlunoHasDisciplinas.obter(pegarCpf);
                    

                    if (JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(cp,
                            //                            "Confirma a exclusão desse tipo de conta [" + tableModel.getValue(table.getSelectedRow()).getAlunoHasDisciplinasPK().getAlunoCpf() + " - "
                            //                            + tableModel.getValue(table.getSelectedRow()).getAlunoHasDisciplinasPK().getDisciplinasIdDisciplinas() + "]?", "Confirm",
        ...
        btnAdd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    try {
                        DisciplinasHasModalidades c = daoDisciplinasHasModalidades.obter(Integer.valueOf(d));
                        ...
                        for (Disciplinas aux : listaDisciplinas) {
                            ...
                            String aaa = aux.getNomeDisciplinas();
                        ...
                        GUIDisciplinasModalidades xxx = new GUIDisciplinasModalidades(a,Integer.valueOf(d));
...
//                try {
                    ...
                    if (table.getSelectedRow() != -1 && table.getSelectedRow() < tableModel.getRowCount()) {
                        ...
                        int a=Integer.valueOf(pegarCpf);
                        String b=String.valueOf(table.getValueAt(table.getSelectedRow(), 1));
                         new RemoverEntidadeTable1(a,b);
...
//                }
            ...
            public void actionPerformed(ActionEvent e) {
              //  Disciplinas disciplinas = new Disciplinas();
                ...
                try {
                  ...
                  //  String aux3 = "";
                    //List<DisciplinasHasModalidades> lc1 = daoDisciplinasHasModalidades.list();
                    ...
                    for (DisciplinasHasModalidades aux : lc) {
                        ...
                        if (a.getModalidadesIdModalidades()==Integer.valueOf(pegarCpf)) {
                            Disciplinas io = daoDisciplinas.obter(a.getDisciplinasIdDisciplinas());
                            
                            map.put(a.getDisciplinasIdDisciplinas(), io.getNomeDisciplinas() );
        ...
        tableModel.addTableModelListener(new TableModelListener() {
            ...
            public void tableChanged(TableModelEvent e) {
                ...
                if (table.getSelectedRow() != -1 && table.getSelectedRow() < tableModel.getRowCount()) {
                    String ee = tableModel.getValue(table.getSelectedRow());
                    DisciplinasHasModalidades eee = daoDisciplinasHasModalidades.obter(ee);
                    DisciplinasHasModalidades c = eee;
                    daoDisciplinasHasModalidades.atualizar(c);
                }
                //}
    ...
    public static void main(String[] args) {
        AlunoModalidadeJTable1 alunoModalidadeJTable = new AlunoModalidadeJTable1("1");
    }
}
