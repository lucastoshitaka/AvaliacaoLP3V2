...
public class AlunoModalidadeTableModel1 extends AbstractTableModel {

    private final Class classes[] = new Class[]{Integer.class, String.class};
    private final String colunas[] = new String[]{"Modalidade", "Disciplinas"};
    private List<String> dados;
    private String pegarCpf;
    private final SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
    //private final SimpleDateFormat timeformat = new SimpleDateFormat("h:mm a");

    public AlunoModalidadeTableModel1(List<String> dados) {
        this.dados = dados;
    }
